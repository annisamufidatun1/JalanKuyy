            ...
            <div class="modal-content" style="border-radius: 15px;">
                ...
                <div class="modal-body" >
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-4">
                                <img src="data_file/pestapora.png" alt="" style="height: 220px; width: 220px; margin-left:5px; margin-top: 5px">
                            </div>
                            <div class="col-8">
                                <h5 style="font-family: 'Poppins'; font-weight: 700; font-size: 20px; color: #143362">Pestapora</h5>
                                <p style="font-size: 15px; vertical-align:middle; margin:10px 0">
                                    <iconify-icon icon="ion:location-outline" style="font-size: 25px; color: black; vertical-align:middle"></iconify-icon> Jakarta
                                </p>
                                <p style="font-size: 15px; vertical-align:middle; margin:0">
                                    <iconify-icon icon="ant-design:star-filled" style="font-size: 25px; color: black; vertical-align:middle"></iconify-icon> 4
...
<?php /**PATH C:\xampp\htdocs\dbjalankuy\resources\views/layouts/template.blade.php ENDPATH**/ ?>